...
Version  : 1.38.1
Release  : 1
URL      : https://files.pythonhosted.org/packages/0b/09/673c457b4da58f37ff65d052aaa52b02f43caf75d765d121b021e4a4a8a7/grpcio-health-checking-1.38.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/0b/09/673c457b4da58f37ff65d052aaa52b02f43caf75d765d121b021e4a4a8a7/grpcio-health-checking-1.38.1.tar.gz
...
%prep
%setup -q -n grpcio-health-checking-1.38.1
cd %{_builddir}/grpcio-health-checking-1.38.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624573291
...
cp %{_builddir}/grpcio-health-checking-1.38.1/LICENSE %{buildroot}/usr/share/package-licenses/grpcio-health-checking/2b8b815229aa8a61e483fb4ba0588b8b6c491890
