...
%prep
%setup -q -n grpcio-health-checking-1.42.0
cd %{_builddir}/grpcio-health-checking-1.42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637195175
...
cp %{_builddir}/grpcio-health-checking-1.42.0/LICENSE %{buildroot}/usr/share/package-licenses/grpcio-health-checking/34ac89724cb7e3fb36bcfe93efabfd012c569a0e
...
/usr/share/package-licenses/grpcio-health-checking/34ac89724cb7e3fb36bcfe93efabfd012c569a0e
